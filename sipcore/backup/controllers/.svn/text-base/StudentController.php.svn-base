	...
	public function accessRules()
	{
        ...
        public function filterViewStudentStats($c) {
            if (Yii::app()->user->isGuest)
                throw new CHttpException(400,'Acces respins.');
            ...
            if (Yii::app()->user->checkAccess('admin'))
                ...
                if ($account->type == Account::TYPE_STUDENT && $account->info==$this->loadModel($_GET['id'])) {
                    $c->run();
	...
	public function actionCreate($class)
	{
		...
		if(isset($_POST['Student'], $_POST['Parents'], $_POST['sAccount'], $_POST['pAccount']))
		{
                    ...
                    if ($valid) {
                        ...
                        $this->redirect(array('create','class'=>$class,'saved'=>$saved));
                    }
		}
