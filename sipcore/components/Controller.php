...
class Controller extends CController {
     ...
     * and the second is a string to be used as the actual title or an array as second argument to renderPartial.
     * If it is a string, it is the page title. The default view is "//layouts/headers/normal.php"
     */
