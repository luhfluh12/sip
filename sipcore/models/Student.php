...
class Student extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, class, school, parent, name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
            ...
            return array(
                ...
                'rParent'=>array(self::BELONGS_TO,'Parents','parent'),
                'rSchool'=>array(self::BELONGS_TO,'School','school'),
                'rSmses'=>array(self::HAS_MANY,'Sms','student','order'=>'sent, added DESC','on'=>'status='.Sms::STATUS_SENT),
                'rSmsesAll'=>array(self::HAS_MANY,'Sms','student','order'=>'sent, added DESC'),
	...
	public function search()
	{
        ...
        protected function beforeSave() {
            if (parent::beforeSave()) {
                if (Classes::model()->canAddStudent($this->class)===true)
                    return true;
                else {
